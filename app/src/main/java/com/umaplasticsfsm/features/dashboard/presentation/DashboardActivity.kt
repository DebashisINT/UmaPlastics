package com.umaplasticsfsm.features.dashboard.presentation
...
import com.umaplasticsfsm.*
import com.umaplasticsfsm.R
import com.umaplasticsfsm.app.*
import com.umaplasticsfsm.app.NewFileUtils.browseDocuments
import com.umaplasticsfsm.app.NewFileUtils.browsePDFDocuments
import com.umaplasticsfsm.app.NewFileUtils.getExtension
import com.umaplasticsfsm.app.domain.*
import com.umaplasticsfsm.app.types.DashboardType
import com.umaplasticsfsm.app.types.FragType
import com.umaplasticsfsm.app.types.TopBarConfig
import com.umaplasticsfsm.app.uiaction.DisplayAlert
import com.umaplasticsfsm.app.utils.*
import com.umaplasticsfsm.app.utils.AppUtils.Companion.isProfile
...
import com.umaplasticsfsm.features.NewQuotation.*
import com.umaplasticsfsm.features.NewQuotation.api.GetQuotRegProvider
import com.umaplasticsfsm.features.NewQuotation.model.ViewDetailsQuotResponse
import com.umaplasticsfsm.features.SearchLocation.SearchLocationFragment
import com.umaplasticsfsm.features.SearchLocation.locationInfoModel
import com.umaplasticsfsm.features.TA.ViewAllTAListFragment
import com.umaplasticsfsm.features.achievement.AchievementFragment
import com.umaplasticsfsm.features.activities.presentation.*
import com.umaplasticsfsm.features.addAttendence.*
import com.umaplasticsfsm.features.addAttendence.api.addattendenceapi.AddAttendenceRepoProvider
import com.umaplasticsfsm.features.addAttendence.api.leavetytpeapi.LeaveTypeRepoProvider
import com.umaplasticsfsm.features.addAttendence.model.GetReportToFCMResponse
import com.umaplasticsfsm.features.addAttendence.model.GetReportToResponse
import com.umaplasticsfsm.features.addAttendence.model.Leave_list_Response
import com.umaplasticsfsm.features.addorder.presentation.AddOrderFragment
...
import com.umaplasticsfsm.features.addshop.presentation.AddShopFragment
import com.umaplasticsfsm.features.addshop.presentation.OTPVerificationDialog
import com.umaplasticsfsm.features.addshop.presentation.ScanImageFragment
import com.umaplasticsfsm.features.addshop.presentation.ShowCardDetailsDialog
import com.umaplasticsfsm.features.alarm.model.AlarmData
import com.umaplasticsfsm.features.alarm.presetation.AttendanceReportFragment
import com.umaplasticsfsm.features.alarm.presetation.PerformanceReportFragment
import com.umaplasticsfsm.features.alarm.presetation.VisitReportDetailsFragment
import com.umaplasticsfsm.features.alarm.presetation.VisitReportFragment
import com.umaplasticsfsm.features.attendance.AttendanceFragment
import com.umaplasticsfsm.features.attendance.api.AttendanceRepositoryProvider
import com.umaplasticsfsm.features.attendance.model.AttendanceRequest
import com.umaplasticsfsm.features.attendance.model.AttendanceResponse
import com.umaplasticsfsm.features.averageshop.presentation.AverageShopFragment
import com.umaplasticsfsm.features.avgorder.presentation.AverageOrderFragment
import com.umaplasticsfsm.features.avgtimespent.presentation.AvgTimespentShopListFragment
import com.umaplasticsfsm.features.beatCustom.TeamBeatListFragment
import com.umaplasticsfsm.features.billing.presentation.AddBillingFragment
import com.umaplasticsfsm.features.billing.presentation.BillingDetailsFragment
import com.umaplasticsfsm.features.billing.presentation.BillingListFragment
import com.umaplasticsfsm.features.changepassword.presentation.ChangePasswordDialog
import com.umaplasticsfsm.features.chat.model.ChatListDataModel
import com.umaplasticsfsm.features.chat.model.ChatUserDataModel
import com.umaplasticsfsm.features.chat.model.GroupUserDataModel
import com.umaplasticsfsm.features.chat.presentation.*
import com.umaplasticsfsm.features.chatbot.presentation.ChatBotFragment
import com.umaplasticsfsm.features.chatbot.presentation.ChatBotShopListFragment
import com.umaplasticsfsm.features.chatbot.presentation.ReportsFragment
import com.umaplasticsfsm.features.chatbot.presentation.SelectLanguageDialog
import com.umaplasticsfsm.features.commondialog.presentation.CommonDialog
import com.umaplasticsfsm.features.commondialog.presentation.CommonDialogClickListener
import com.umaplasticsfsm.features.commondialogsinglebtn.AddFeedbackSingleBtnDialog
import com.umaplasticsfsm.features.commondialogsinglebtn.CommonDialogSingleBtn
import com.umaplasticsfsm.features.commondialogsinglebtn.OnDialogClickListener
import com.umaplasticsfsm.features.commondialogsinglebtn.TermsAndConditionsSingleBtnDialog
import com.umaplasticsfsm.features.contacts.ContactDtls
import com.umaplasticsfsm.features.contacts.ContactGr
import com.umaplasticsfsm.features.contacts.ContactMasterRes
import com.umaplasticsfsm.features.contacts.ContactsAddFrag
import com.umaplasticsfsm.features.contacts.ContactsFrag
import com.umaplasticsfsm.features.contacts.SchedulerAddFormFrag
import com.umaplasticsfsm.features.contacts.SchedulerAddFrag
import com.umaplasticsfsm.features.contacts.TypeMasterRes
import com.umaplasticsfsm.features.dailyPlan.prsentation.AllShopListFragment
import com.umaplasticsfsm.features.dailyPlan.prsentation.DailyPlanListFragment
import com.umaplasticsfsm.features.dailyPlan.prsentation.PlanDetailsFragment
import com.umaplasticsfsm.features.damageProduct.ShopDamageProductListFrag
import com.umaplasticsfsm.features.damageProduct.ShopDamageProductSubmitFrag
import com.umaplasticsfsm.features.dashboard.presentation.api.ShopVisitImageUploadRepoProvider
import com.umaplasticsfsm.features.dashboard.presentation.api.dashboardApi.DashboardRepoProvider
import com.umaplasticsfsm.features.dashboard.presentation.api.otpsentapi.OtpSentRepoProvider
import com.umaplasticsfsm.features.dashboard.presentation.api.otpverifyapi.OtpVerificationRepoProvider
import com.umaplasticsfsm.features.dashboard.presentation.api.unreadnotificationapi.UnreadNotificationRepoProvider
import com.umaplasticsfsm.features.dashboard.presentation.getcontentlisapi.GetContentListRepoProvider
import com.umaplasticsfsm.features.dashboard.presentation.model.ContentListResponseModel
import com.umaplasticsfsm.features.dashboard.presentation.model.ShopVisitImageUploadInputModel
import com.umaplasticsfsm.features.dashboard.presentation.model.UnreadNotificationResponseModel
import com.umaplasticsfsm.features.device_info.presentation.DeviceInfoListFragment
import com.umaplasticsfsm.features.distributorwiseorder.DistributorwiseorderlistFragment
import com.umaplasticsfsm.features.document.DocumentRepoFeatureNewFragment
import com.umaplasticsfsm.features.document.presentation.DocumentListFragment
import com.umaplasticsfsm.features.document.presentation.DocumentTypeListFragment
import com.umaplasticsfsm.features.document.presentation.OpenFileWebViewFragment
import com.umaplasticsfsm.features.dymanicSection.presentation.AddDynamicFragment
import com.umaplasticsfsm.features.dymanicSection.presentation.AllDynamicListFragment
import com.umaplasticsfsm.features.dymanicSection.presentation.DynamicListFragment
import com.umaplasticsfsm.features.dymanicSection.presentation.EditDynamicFragment
import com.umaplasticsfsm.features.gpsDisabilityScreen.GpsDisableFragment
import com.umaplasticsfsm.features.home.presentation.HomeFragment
import com.umaplasticsfsm.features.homelocation.presentation.HomeLocationFragment
import com.umaplasticsfsm.features.homelocation.presentation.HomeLocationMapFragment
import com.umaplasticsfsm.features.know_your_state.KnowYourStateFragment
import com.umaplasticsfsm.features.lead.LeadFrag
import com.umaplasticsfsm.features.lead.ViewLeadFrag
import com.umaplasticsfsm.features.leaveapplynew.LeaveHome
import com.umaplasticsfsm.features.leaveapplynew.model.clearAttendanceonRejectReqModelRejectReqModel
import com.umaplasticsfsm.features.localshops.LocalShopListFragment
import com.umaplasticsfsm.features.localshops.LocalShopListMapFragment
import com.umaplasticsfsm.features.localshops.NearByShopsMapFragment
import com.umaplasticsfsm.features.location.*
import com.umaplasticsfsm.features.location.api.LocationRepoProvider
import com.umaplasticsfsm.features.location.model.*
import com.umaplasticsfsm.features.location.shopRevisitStatus.ShopRevisitStatusRepositoryProvider
import com.umaplasticsfsm.features.location.shopdurationapi.ShopDurationRepositoryProvider
import com.umaplasticsfsm.features.login.ShopFeedbackEntity
import com.umaplasticsfsm.features.login.model.alarmconfigmodel.AlarmConfigDataModel
import com.umaplasticsfsm.features.login.presentation.LoginActivity
import com.umaplasticsfsm.features.logout.presentation.api.LogoutRepositoryProvider
import com.umaplasticsfsm.features.logoutsync.presentation.LogoutSyncFragment
import com.umaplasticsfsm.features.marketAssist.MarketAssistTabFrag
import com.umaplasticsfsm.features.marketAssist.ShopDtlsMarketAssistFrag
import com.umaplasticsfsm.features.marketAssist.ShopListMarketAssistFrag
import com.umaplasticsfsm.features.marketing.presentation.MarketingPagerFragment
import com.umaplasticsfsm.features.meetinglist.prsentation.MeetingListFragment
import com.umaplasticsfsm.features.member.MapViewForTeamFrag
import com.umaplasticsfsm.features.member.model.TeamLocDataModel
import com.umaplasticsfsm.features.member.model.TeamShopListDataModel
import com.umaplasticsfsm.features.member.presentation.*
import com.umaplasticsfsm.features.menuBeat.MenuBeatFrag
import com.umaplasticsfsm.features.micro_learning.presentation.FileOpeningTimeIntentService
import com.umaplasticsfsm.features.micro_learning.presentation.MicroLearningListFragment
import com.umaplasticsfsm.features.micro_learning.presentation.MicroLearningWebViewFragment
import com.umaplasticsfsm.features.myallowancerequest.MyallowanceRequestFragment
import com.umaplasticsfsm.features.myjobs.model.CustomerDataModel
import com.umaplasticsfsm.features.myjobs.presentation.*
import com.umaplasticsfsm.features.myorder.presentation.MyOrderListFragment
import com.umaplasticsfsm.features.myprofile.presentation.MyProfileFragment
import com.umaplasticsfsm.features.nearbyshops.api.ShopListRepositoryProvider
import com.umaplasticsfsm.features.nearbyshops.model.ShopData
import com.umaplasticsfsm.features.nearbyshops.model.ShopListResponse
import com.umaplasticsfsm.features.nearbyshops.multipleattachImage.MultipleImageFragment
import com.umaplasticsfsm.features.nearbyshops.presentation.BeatListFragment
import com.umaplasticsfsm.features.nearbyshops.presentation.NearByShopsListFragment
import com.umaplasticsfsm.features.nearbyshops.presentation.NewNearByShopsListFragment
import com.umaplasticsfsm.features.nearbyshops.presentation.ShopCallHisFrag
import com.umaplasticsfsm.features.nearbyuserlist.presentation.NearbyUserListFragment
import com.umaplasticsfsm.features.newcollection.CollectionDetailsStatusFragment
import com.umaplasticsfsm.features.newcollection.CollectionShopListFragment
import com.umaplasticsfsm.features.newcollection.NewCollectionListFragment
import com.umaplasticsfsm.features.newcollectionreport.*
import com.umaplasticsfsm.features.notification.NotificationFragment
import com.umaplasticsfsm.features.orderList.NewDateWiseOrderListFragment
import com.umaplasticsfsm.features.orderList.NewOrderListFragment
import com.umaplasticsfsm.features.orderList.OrderListFragment
import com.umaplasticsfsm.features.orderdetail.presentation.OrderDetailFragment
import com.umaplasticsfsm.features.orderhistory.ActivityMapFragment
import com.umaplasticsfsm.features.orderhistory.OrderhistoryFragment
import com.umaplasticsfsm.features.orderhistory.TimeLineFragment
import com.umaplasticsfsm.features.orderhistory.activitiesapi.LocationFetchRepositoryProvider
...
import com.umaplasticsfsm.features.orderhistory.model.LocationData
import com.umaplasticsfsm.features.pendinglocationinout.PendingOutLocationFrag
import com.umaplasticsfsm.features.performance.GpsStatusFragment
import com.umaplasticsfsm.features.performance.PerformanceFragment
import com.umaplasticsfsm.features.performance.api.UpdateGpsStatusRepoProvider
import com.umaplasticsfsm.features.performance.model.UpdateGpsInputParamsModel
import com.umaplasticsfsm.features.performanceAPP.OwnPerformanceFragment
import com.umaplasticsfsm.features.performanceAPP.PerformanceAppFragment
import com.umaplasticsfsm.features.performanceAPP.allPerformanceFrag
import com.umaplasticsfsm.features.permissionList.ViewPermissionFragment
import com.umaplasticsfsm.features.photoReg.*
import com.umaplasticsfsm.features.privacypolicy.PrivacypolicyWebviewFrag
import com.umaplasticsfsm.features.quotation.presentation.*
import com.umaplasticsfsm.features.reimbursement.presentation.*
import com.umaplasticsfsm.features.report.presentation.*
import com.umaplasticsfsm.features.returnsOrder.*
import com.umaplasticsfsm.features.settings.presentation.SettingsFragment
import com.umaplasticsfsm.features.shopFeedbackHistory.ShopFeedbackHisFrag
import com.umaplasticsfsm.features.shopdetail.presentation.*
import com.umaplasticsfsm.features.shopdetail.presentation.api.EditShopRepoProvider
import com.umaplasticsfsm.features.stock.StockDetailsFragment
import com.umaplasticsfsm.features.stock.StockListFragment
import com.umaplasticsfsm.features.stockAddCurrentStock.AddShopStockFragment
import com.umaplasticsfsm.features.stockAddCurrentStock.UpdateShopStockFragment
import com.umaplasticsfsm.features.stockAddCurrentStock.ViewStockDetailsFragment
import com.umaplasticsfsm.features.stockAddCurrentStock.model.MultipleImageFileUploadonStock
import com.umaplasticsfsm.features.stockCompetetorStock.AddCompetetorStockFragment
import com.umaplasticsfsm.features.stockCompetetorStock.CompetetorStockFragment
import com.umaplasticsfsm.features.stockCompetetorStock.ViewComStockProductDetails
import com.umaplasticsfsm.features.survey.SurveyFrag
import com.umaplasticsfsm.features.survey.SurveyViewDtlsFrag
import com.umaplasticsfsm.features.survey.SurveyViewFrag
import com.umaplasticsfsm.features.task.presentation.AddTaskFragment
import com.umaplasticsfsm.features.task.presentation.CalenderTaskFragment
import com.umaplasticsfsm.features.task.presentation.EditTaskFragment
import com.umaplasticsfsm.features.task.presentation.TaskListFragment
import com.umaplasticsfsm.features.taskManagement.TaskManagementFrag
import com.umaplasticsfsm.features.taskManagement.ViewTaskManagementFrag
import com.umaplasticsfsm.features.timesheet.presentation.AddTimeSheetFragment
import com.umaplasticsfsm.features.timesheet.presentation.EditTimeSheetFragment
import com.umaplasticsfsm.features.timesheet.presentation.TimeSheetListFragment
import com.umaplasticsfsm.features.viewAllOrder.CartFragment
import com.umaplasticsfsm.features.viewAllOrder.OrderTypeListFragment
import com.umaplasticsfsm.features.viewAllOrder.ViewAllOrderListFragment
import com.umaplasticsfsm.features.viewAllOrder.ViewCartFragment
import com.umaplasticsfsm.features.viewAllOrder.orderNew.NewOdrScrListFragment
import com.umaplasticsfsm.features.viewAllOrder.orderNew.NewOrderScrActiFragment
import com.umaplasticsfsm.features.viewAllOrder.orderNew.NewOrderScrOrderDetailsFragment
import com.umaplasticsfsm.features.viewAllOrder.orderNew.NeworderScrCartFragment
import com.umaplasticsfsm.features.viewAllOrder.orderOptimized.OrderProductCartFrag
import com.umaplasticsfsm.features.viewAllOrder.orderOptimized.OrderProductListFrag
import com.umaplasticsfsm.features.viewPPDDStock.ViewOutstandingFragment
import com.umaplasticsfsm.features.viewPPDDStock.ViewPPDDListFragment
import com.umaplasticsfsm.features.viewPPDDStock.ViewPPDDListOutstandingFragment
import com.umaplasticsfsm.features.viewPPDDStock.ViewStockFragment
import com.umaplasticsfsm.features.weather.presentation.WeatherFragment
import com.umaplasticsfsm.mappackage.MapActivity
import com.umaplasticsfsm.mappackage.MapActivityWithoutPath
import com.umaplasticsfsm.mappackage.SendBrod
import com.umaplasticsfsm.widgets.AppCustomEditText
import com.umaplasticsfsm.widgets.AppCustomTextView
...
//        val phototUri = Uri.parse(localAbsoluteFilePath)
            //val fileUrl = Uri.parse(File(Environment.getExternalStorageDirectory(), "xumaplasticsfsmlogsample/log").path);
            //27-09-2021
//            val fileUrl = Uri.parse(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xumaplasticsfsmlogsample/log").path);
...
//                BuildConfig.APPLICATION_ID+"/Log/Fsmlog.html").path);
            var currentDBPath="/data/user/0/com.umaplasticsfsm/files/Fsmlog.html"
...
//        startActivity(Intent.createChooser(emailIntent,""))
    ...
    fun openShare(){
        try{
            ...
            val fileUrl1 = Uri.parse(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xumaplasticsfsmlogsample/log").path);
            val fileUrl2 = Uri.parse(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xumaplasticsfsmlogsample/log.bak.1").path);
...
//        return super.onCreateOptionsMenu(menu)
    ...
    fun generateNoteOnSD(context: Context?, sFileName: String?, sBody: String?) {
        try {
            val root =  File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xumaplasticsfsmlogsample/log" + ".txt")
            if (!root.exists()) {
                root.mkdirs()
            }
...
//        }
        val bytes = ByteArrayOutputStream()
//        bm!!.compress(Bitmap.CompressFormat.JPEG, 90, bytes)
        var destination = File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xumaplasticsfsmlogsample/log")
        val fo: FileOutputStream
        val fo1:FileWriter
        try {
            fo = FileOutputStream(destination)
