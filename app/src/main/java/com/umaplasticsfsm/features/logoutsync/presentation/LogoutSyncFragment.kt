package com.umaplasticsfsm.features.logoutsync.presentation
...
import com.umaplasticsfsm.base.presentation.BaseActivity.Companion.compositeDisposable
...
import com.umaplasticsfsm.features.billing.api.AddBillingRepoProvider
import com.umaplasticsfsm.features.billing.model.AddBillingInputParamsModel
...
import com.umaplasticsfsm.features.dashboard.presentation.ReasonDialog
...
import com.umaplasticsfsm.features.document.model.AddEditDocumentInputParams
import com.umaplasticsfsm.features.document.model.DocumentAttachmentModel
...
import com.umaplasticsfsm.features.nearbyshops.api.updateaddress.ShopAddressUpdateRepoProvider
import com.umaplasticsfsm.features.nearbyshops.model.updateaddress.AddressUpdateRequest
import com.umaplasticsfsm.features.orderhistory.activitiesapi.LocationFetchRepositoryProvider
import com.umaplasticsfsm.features.orderhistory.api.LocationUpdateRepositoryProviders
import com.umaplasticsfsm.features.orderhistory.model.*
...
import com.umaplasticsfsm.features.quotation.model.AddQuotInputModel
import com.umaplasticsfsm.features.shopdetail.presentation.api.EditShopRepoProvider
import com.umaplasticsfsm.features.shopdetail.presentation.api.addcollection.AddCollectionRepoProvider
import com.umaplasticsfsm.features.shopdetail.presentation.model.addcollection.AddCollectionInputParamsModel
import com.umaplasticsfsm.features.stock.api.StockRepositoryProvider
import com.umaplasticsfsm.features.stock.model.AddStockInputParamsModel
import com.umaplasticsfsm.features.stockAddCurrentStock.AddShopStockFragment
import com.umaplasticsfsm.features.stockAddCurrentStock.ShopAddCurrentStockList
...
import com.umaplasticsfsm.features.timesheet.model.AddTimeSheetInputModel
import com.umaplasticsfsm.features.viewAllOrder.api.addorder.AddOrderRepoProvider
import com.umaplasticsfsm.features.viewAllOrder.model.AddOrderInputParamsModel
import com.umaplasticsfsm.features.viewAllOrder.model.AddOrderInputProductList
import com.umaplasticsfsm.mappackage.SendBrod
import com.umaplasticsfsm.widgets.AppCustomTextView
import com.umaplasticsfsm.MonitorService
import com.umaplasticsfsm.MySingleton
...
import com.umaplasticsfsm.features.addshop.presentation.ShopExtraContactReq
...
import com.umaplasticsfsm.features.login.model.GetConcurrentUserResponse
import com.umaplasticsfsm.features.login.model.WhatsappApiData
import com.umaplasticsfsm.features.performance.model.Gps_status_list
import com.umaplasticsfsm.features.performance.model.UpdateGpsInputListParamsModel
import com.umaplasticsfsm.features.returnsOrder.ReturnProductList
import com.umaplasticsfsm.features.returnsOrder.ReturnRequest
import com.umaplasticsfsm.features.viewAllOrder.model.NewOrderSaveApiModel
...
//            checkToCallActivity()
    ...
    private fun callLogshareApi(){
        ...
        if(Pref.LogoutWithLogFile){
            try{
                val filesForZip: Array<String> = arrayOf(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xumaplasticsfsmlogsample/log").path)
                ZipOutputStream(BufferedOutputStream(FileOutputStream(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xumaplasticsfsmlogsample/log.zip").path))).use { out ->
                ...
                val fileUrl = Uri.parse(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xumaplasticsfsmlogsample/log.zip").path);
